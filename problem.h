vector<Problem> problems = {
    ...
    {"对评测结果有疑义，需要申请复评，则", {{"提出书面申请", true}, {"经领队、科学委员会主席签字确认", true}, {"提交至 NOI 科学委员会评测组", true}, {"经教练签字"}}},
    ...
    {"在 NOI 机试中，允许选手使用的编程语言包括", {{"C"}, {"C++", true}, {"Pascal"}, {"Python"}}},
    ...
    {"字长为 64 位的计算机，表示它能作为一个整体进行传送的数据长度可为多少个字节", {{"8", true}, {"4"}, {"16"}, {"64"}}},
    ...
    {"NOI2024 是第几届 NOI？", {{"41", true}, {"40"}, {"36"}, {"37"}}},
    {"IOI2024 是第几届 IOI？", {{"36", true}, {"37"}, {"40"}, {"41"}}},
