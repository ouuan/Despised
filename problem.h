vector<Problem> problems = {
    ...
    {"当前目录中有如下文件：\n-rw-r--r-- 1 user None 8.7K Jul 2 16:35 a\n-rw-r--r-- 1 user None 93 Jul 2 16:35 a.c++\n-rwx------ 1 user None 144 Jul 2 16:35 a.sh\n其中，可以执行的文件是", {{"a.sh", true}, {"a.c++"}, {"a"}, {"都不可执行"}}},
    ...
    {"目录 FOLDER 和目录 Folder 在 Linux 系统中被认为是", {{"不同的目录", true}, {"相同的目录"}}},
    ...
    {"在 NOI 赛场上，选手自测时可以使用的指定工具是", {{"SelfEval", true}, {"GDB"}, {"Vim"}, {"VS Code"}}},
    {"在 NOI 赛场上，选手使用 SelfEval 得到的自测结果是否可以作为正式成绩", {{"否", true}, {"是"}}},
    ...
    {"在信息领域，IT 的常见含义是", {{"信息技术", true}, {"信息学"}, {"信息学竞赛"}, {"全国信息学竞赛"}}},
    ...
    {"NOI2026 是第几届 NOI？", {{"43", true}, {"42"}, {"38"}, {"39"}}},
    {"IOI2026 是第几届 IOI？", {{"38", true}, {"39"}, {"42"}, {"43"}}},
